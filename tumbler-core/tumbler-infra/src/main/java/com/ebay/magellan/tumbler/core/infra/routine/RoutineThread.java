...
import com.ebay.magellan.tumbler.core.infra.routine.execute.RoutineExecutor;
import com.ebay.magellan.tumbler.core.infra.routine.execute.RoutineExecutorFactory;
import com.ebay.magellan.tumbler.core.infra.routine.alive.RoutineOccupation;
import com.ebay.magellan.tumbler.core.infra.routine.heartbeat.RoutineHeartBeatThread;
import com.ebay.magellan.tumbler.core.infra.routine.heartbeat.RoutineHeartBeatThreadFactory;
import com.ebay.magellan.tumbler.core.infra.routine.heartbeat.RoutineHeartBeatThreadPoolExecutor;
import com.ebay.magellan.tumbler.core.infra.routine.help.RoutineOccupyHelper;
...
import com.ebay.magellan.tumbler.depend.common.util.ThreadUtil;
...
public class RoutineThread implements Runnable {
    ...
    void tryOccupyRoutine() throws TumblerException {
    ...
    void buildRoutineExecutor() throws TumblerException {
    ...
    void routineStartUp() throws TumblerException {
    ...
    // try work on routine
    void tryWorkOnRoutine() throws TumblerException {
        try {
            workOnRoutine();
        } catch (TumblerException e) {
            logger.error(THIS_CLASS_NAME,
    ...
    // while loop to work
    void workOnRoutine() throws TumblerException {
        // build and init routine executor, as well as heartbeat
        routineStartUp();
    ...
    boolean routineOccupiable() throws TumblerException {
    ...
    boolean routineExecutable() throws TumblerException {
        if (occupiedRoutine == null) return false;
    ...
    void executeRound() throws TumblerException {
        // execute round
    ...
    void updateRoutineCheckpoint() throws TumblerException {
    ...
    void finishRoutine() throws TumblerException {
