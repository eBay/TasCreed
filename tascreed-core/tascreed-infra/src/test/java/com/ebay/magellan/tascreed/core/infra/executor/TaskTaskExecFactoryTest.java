...
public class TaskTaskExecFactoryTest {
    ...
    public void getTaskExecutorClassByName() {
        assertEquals(TestNmExecutor.class, factory.getTaskExecutorClassByName("com.ebay.magellan.tascreed.core.infra.executor.help.TestNmExecutor"));
        assertEquals(TestCpExecutor.class, factory.getTaskExecutorClassByName("com.ebay.magellan.tascreed.core.infra.executor.help.TestCpExecutor"));
        assertNull(factory.getTaskExecutorClassByName("com.ebay.magellan.tascreed.core.infra.executor.help.UnknownExecutor"));
    }
    ...
    public void getTaskExecutorClass() {
        ...
        assertEquals(TestNmExecutor.class, factory.getTaskExecutorClass(
                buildTask("j1", "s2", "com.ebay.magellan.tascreed.core.infra.executor.help.TestNmExecutor")));
        assertEquals(TestCpExecutor.class, factory.getTaskExecutorClass(
                buildTask("j1", "s1", "com.ebay.magellan.tascreed.core.infra.executor.help.TestCpExecutor")));
        assertNull(factory.getTaskExecutorClass(
                buildTask("j1", "s2", "com.ebay.magellan.tascreed.core.infra.executor.help.UnknownExecutor")));
    }
