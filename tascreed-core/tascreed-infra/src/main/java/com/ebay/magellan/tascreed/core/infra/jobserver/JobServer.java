...
import com.ebay.magellan.tascreed.core.domain.builder.JobUpdateBuilder;
...
import com.ebay.magellan.tascreed.core.domain.validate.JobValidator;
...
public class JobServer {
    ...
    public Job createNewJob(JobRequest jr) throws TcException {
        ...
        if (!vr.isValid()) {
            TcExceptionBuilder.throwTcException(
                    TcErrorEnum.TC_FATAL_VALIDATION_EXCEPTION, vr.showMsg());
        }
