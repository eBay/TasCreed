...
import com.ebay.magellan.tumbler.core.infra.taskworker.help.TaskOccupyHelper;
...
import com.ebay.magellan.tumbler.depend.common.retry.*;
...
import com.ebay.magellan.tumbler.core.infra.executor.TaskExecutor;
import com.ebay.magellan.tumbler.core.infra.executor.TaskExecutorFactory;
import com.ebay.magellan.tumbler.core.infra.taskworker.heartbeat.TaskHeartBeatThread;
import com.ebay.magellan.tumbler.core.infra.taskworker.heartbeat.TaskHeartBeatThreadFactory;
import com.ebay.magellan.tumbler.core.infra.taskworker.heartbeat.TaskHeartBeatThreadPoolExecutor;
...
public class TaskWorkerThread implements Runnable {
    ...
    void tryOccupyTask() throws TumblerException {
        ...
        while (tumblerGlobalConfig.isTaskWatcherSwitchOn(true)) {
            try {
    ...
    void workOnTask() throws TumblerException {
        ...
        while (isTaskAlive() && tumblerGlobalConfig.isTaskWatcherSwitchOn(false)) {
    ...
    boolean updateTaskPickedTimes() throws TumblerException {
        ...
        int maxPickTimes = DefaultValueUtil.intValue(
                ...
                tumblerConstants.getTaskDefaultMaxPickTimes());
